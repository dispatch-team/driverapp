...
class _FilterPills extends StatelessWidget {
  ...
  static const List<(ShipmentStatus?, String)> _filters = [
    (null, 'history_filter_all'),
    (ShipmentStatus.delivered, 'history_filter_delivered'),
    (ShipmentStatus.failed, 'history_filter_failed'),
  ];
